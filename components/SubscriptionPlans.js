...
const SubscriptionPlans = () => {
  ...
  return (
    <ImageBackground
      source={require('../assets/all_images/Subscription Plans/Image 116.png')}
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          <View style={styles.imageContainer}>
            <Image
              style={styles.image}
              source={require('../assets/all_images/Subscription Plans/Unlimitedmusic selections.png')}
            />
          </View>
          ...
          <TouchableOpacity
            ...
            <Image
              source={require('../assets/all_images/Subscription Plans/Button 17.png')}
